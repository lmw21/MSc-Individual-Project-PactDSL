 ...
 * </p>
 * <ul>
 *   <li>{@link imperialmsc.lmw21.pactdsl.pactDSL.impl.EntityTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link imperialmsc.lmw21.pactdsl.pactDSL.impl.EntityTypeImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link imperialmsc.lmw21.pactdsl.pactDSL.impl.EntityTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link imperialmsc.lmw21.pactdsl.pactDSL.impl.EntityTypeImpl#getCompanyNumber <em>Company Number</em>}</li>
 *   <li>{@link imperialmsc.lmw21.pactdsl.pactDSL.impl.EntityTypeImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityTypeImpl extends MinimalEObjectImpl.Container implements EntityType
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PactDSLPackage.ENTITY_TYPE__NAME, oldName, name));
  }
  ...
  public EList<DefinedTerm> getDefinition()
  {
    if (definition == null)
    {
      definition = new EObjectContainmentEList<DefinedTerm>(DefinedTerm.class, this, PactDSLPackage.ENTITY_TYPE__DEFINITION);
    }
    return definition;
  }
  ...
  public EList<Address> getAddress()
  {
    if (address == null)
    {
      address = new EObjectContainmentEList<Address>(Address.class, this, PactDSLPackage.ENTITY_TYPE__ADDRESS);
    }
    return address;
  }
  ...
  public EList<CompanyNumber> getCompanyNumber()
  {
    ...
    {
      companyNumber = new EObjectContainmentEList<CompanyNumber>(CompanyNumber.class, this, PactDSLPackage.ENTITY_TYPE__COMPANY_NUMBER);
    }
  ...
  public EList<Feature> getFeatures()
  {
    if (features == null)
    {
      features = new EObjectContainmentEList<Feature>(Feature.class, this, PactDSLPackage.ENTITY_TYPE__FEATURES);
    }
    return features;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PactDSLPackage.ENTITY_TYPE__DEFINITION:
        return ((InternalEList<?>)getDefinition()).basicRemove(otherEnd, msgs);
      case PactDSLPackage.ENTITY_TYPE__ADDRESS:
        return ((InternalEList<?>)getAddress()).basicRemove(otherEnd, msgs);
      case PactDSLPackage.ENTITY_TYPE__COMPANY_NUMBER:
        return ((InternalEList<?>)getCompanyNumber()).basicRemove(otherEnd, msgs);
      case PactDSLPackage.ENTITY_TYPE__FEATURES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PactDSLPackage.ENTITY_TYPE__NAME:
        return getName();
      case PactDSLPackage.ENTITY_TYPE__DEFINITION:
